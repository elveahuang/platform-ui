<template>
    <div id="create-cropper-modal">
        <a-modal :visible="visible" :title="options.title" :maskClosable="false" :confirmLoading="confirmLoading" :width="600" @cancel="handleCancel">
            <a-row>
...
>
  <img :src="previews.url" :style="previews.img" />
            ...
            <template slot="footer">
                ...
                <a-button key="submit" type="primary" :loading="confirmLoading" @click="handleSumbit"> 确定</a-button>
            </template>
        </a-modal>
    </div>
</template>
