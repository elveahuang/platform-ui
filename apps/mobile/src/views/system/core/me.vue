    ...
    <div class="app-page">
        <div class="app-page-content">
            ...
            <van-cell-group inset>
                <van-cell :title="$t('app.changePassword')" to="/change-password" isLink v-if="isAuthenticated">
                    <template #icon>
                ...
                <van-cell :title="$t('common.label_change_email')" to="/change-email" isLink v-if="isAuthenticated">
                    <template #icon>
                        <van-icon class="app-icon mr-4" size="24">
                ...
                <van-cell :title="$t('common.label_settings')" to="/setting" isLink>
                    <template #icon>
                        <van-icon class="app-icon mr-4" size="24">
                            <v-icon icon="mdi:cog-outline" />
                        </van-icon>
                ...
                <van-cell :title="$t('common.label_about')" to="/about" isLink>
                    <template #icon>
                        <van-icon class="app-icon mr-4" size="24">
                ...
                <van-cell :title="$t('common.label_logout')" isLink @click="handleLogout()" v-if="isAuthenticated">
                    <template #icon>
                        <van-icon class="app-icon mr-4" size="24">
