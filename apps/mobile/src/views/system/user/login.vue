<template>
    ...
    <van-form ref="form" validate-trigger="onSubmit" @submit="onSubmit" @failed="onFailed">
        <van-cell-group inset>
            <van-field v-model="model.username" :placeholder="t('common.user_field_username')" :rules="rules.username"></van-field>
            <van-field
...
import { AppIcon, CodeCaptcha, DarkModePicker, LocalePicker, ThemePicker } from '@commons/mobile/components';
