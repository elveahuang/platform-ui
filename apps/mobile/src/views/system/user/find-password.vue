<template>
    ...
    <van-form v-if="formFindEmailShow" ref="formFindEmail" @submit="onSubmitFindEmail">
        <van-cell-group inset>
            ...
            >
                <template #button>
                    <mail-captcha :email="modelFindEmail.email" @change="handleCaptchaChange" />
                </template>
            </van-field>
        </van-cell-group>
        <div class="m-4">
            <van-button block type="primary" native-type="submit">{{ $t('common.button_next') }}</van-button>
        </div>
    </van-form>
    ...
    <van-form v-if="formResetPasswordShow" ref="formResetPassword" @submit="onSubmitResetPassword">
        ...
        <div class="m-4">
            <van-button block type="primary" native-type="submit">{{ t('common.button_submit') }}</van-button>
        </div>
    </van-form>
